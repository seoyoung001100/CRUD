...
<body>
    ...
    @section('content')
        <div>
            <h1 style="color: #485774">Read</h1>
        </div>
        <div class="writing">
            <div class="writing_header"></div>
            <div class="writing_body">
                <input type="text" class="title" placeholder="제목을 입력해주세요." required><hr> {{-- 데이터 삽입 --}}
                <div class="textarea">
                    <textarea style="resize: none;" name="text" id="text" class="text" cols="125" rows="20" placeholder="내용을 입력해주세요." required></textarea> {{-- 데이터 삽입 --}}
                </div>
            </div>
        </div>
        
        {{-- 관계도 사용해서 본인 글만 수정, 삭제 가능하게 구현 --}}
        <div class="btn">
            <div id="btn_submit" class="btn_submit1"> 
                <input type="submit" value="수장하기">
            </div>
