...
<body>
    ...
    @section('content')
        <div>
            <h1 style="color: #485774">Create</h1>
        </div>
        <div class="writing">
            <div class="writing_header"></div>
            <div class="writing_body">
                <input type="text" class="title" placeholder="제목을 입력해주세요." required><hr>
                <div class="textarea">
                    <textarea style="resize: none;" name="text" id="text" class="text" cols="125" rows="20" placeholder="내용을 입력해주세요." required></textarea>
                </div>
            </div>
        </div>
